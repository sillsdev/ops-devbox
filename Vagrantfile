...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # config.vm.synced_folder "../htdocs", "/var/www/virtual/software.sil.org/htdocs"
  config.vm.synced_folder "../htdocs", "/var/www/virtual/software.sil.org/htdocs", id: "vagrant-root",
    owner: "vagrant",
    group: "www-data",
